...
class CityViewModel: ObservableObject {
  ...
  init(loadTestData: Bool = false) {
    if loadTestData {
      ...
      cities.append(City(name: "New York", image: "imageNewYork", country: "United States", description: "Big Apple!", reviews: [Review(id: UUID(), cityId: UUID(), appUserId: UUID(), rating: 4.1, description: "Wonderful!")], price: 2400.00))
      ...
      cities.append(City(name: "St. Louis", image: "imageStLouis", country: "United State", description: "The Great Arch", reviews: [Review(id: UUID(), cityId: UUID(), appUserId: UUID(), rating: 4.1, description: "Wonderful!")], price: 2400.00))
    }
  }
