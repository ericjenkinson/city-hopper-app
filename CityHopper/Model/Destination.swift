...
class Destination: ObservableObject {
  ...
  init(loadTestData: Bool = false) {
    ...
    cities.append(City(name: "Denver", image: "imageCairo", country: "United States", description: "Mile High!", reviews: [Review(id: UUID(), rating: 4.3, description: "Great!")], price: 1600.00))
    ...
    cities.append(City(name: "San Francisco", image: "imageChicago", country: "United States", description: "", reviews: nil, price: 900.00))
